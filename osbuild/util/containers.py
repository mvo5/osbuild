...
@contextmanager
def containers_storage_source(image, image_name, image_filepath, container_format):
...
@contextmanager
def dir_oci_archive_source(image, _image_name, image_filepath, container_format):
...
def container_source(image):
    ...
    with container_source_fn(image, image_name, image_filepath, container_format) as image_source:
